...
$KUBECTL wait --for=condition=complete job -l 'job-name in (wipe-disks-worker-0, wipe-disks-worker-1, wipe-disks-worker-2, wipe-disks-worker-3)' -n rook-ceph --timeout=300s
