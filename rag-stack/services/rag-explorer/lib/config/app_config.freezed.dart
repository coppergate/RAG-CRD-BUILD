...
mixin _$AppConfig {
 ...
 String get llmGatewayUrl; String get ragIngestionUrl; String get objectStoreMgrUrl; String get dbAdapterUrl; String get qdrantAdapterUrl; String get memoryControllerUrl; String get grafanaUrl; String get ragAdminApiUrl; bool get skipTlsVerification; String? get caCertPath; String get defaultBucketName; bool get darkMode; List<String> get availableModels; bool get memoryExplorerEnabled; bool get modelComparisonEnabled; int get promptTimeoutSeconds;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,llmGatewayUrl,ragIngestionUrl,objectStoreMgrUrl,dbAdapterUrl,qdrantAdapterUrl,memoryControllerUrl,grafanaUrl,ragAdminApiUrl,skipTlsVerification,caCertPath,defaultBucketName,darkMode,const DeepCollectionEquality().hash(_availableModels),memoryExplorerEnabled,modelComparisonEnabled,promptTimeoutSeconds);
