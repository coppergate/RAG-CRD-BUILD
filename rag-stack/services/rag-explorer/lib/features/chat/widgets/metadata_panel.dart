      ...
      child: ListView(
        ...
        children: [
          ...
          if (message == null)
            ...
            _buildMetadataItem('Role', message!.role?.toUpperCase() ?? 'UNKNOWN'),
            _buildMetadataItem('Time', message!.timestamp.toIso8601String().split('T').last.substring(0, 8)),
  ...
  Widget _buildContextSnippet(String source, String text, bool isDarkMode) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(source, style: const TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Colors.blue)),
