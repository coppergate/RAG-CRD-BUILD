...
class SessionDetails extends StatelessWidget {
  ...
  Widget _buildHealthCard(BuildContext context) {
    if (health == null) return const Card(child: Padding(padding: EdgeInsets.all(16), child: Text('No health data.')));
        ...
        if (tags.isEmpty)
          ...
          Wrap(
            ...
            children: tags.map((t) => ActionChip(
              ...
              label: Text(t.name),
              onPressed: () => context.go('/s3?tag=${Uri.encodeComponent(t.name)}'),
