...
mixin _$MemoryPack {
  ...
  $MemoryPackCopyWith<MemoryPack> get copyWith =>
      _$MemoryPackCopyWithImpl<MemoryPack>(this as MemoryPack, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is MemoryPack &&
            const DeepCollectionEquality().equals(other.memories, memories) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(memories),
...
abstract mixin class $MemoryPackCopyWith<$Res> {
  factory $MemoryPackCopyWith(
          MemoryPack value, $Res Function(MemoryPack) _then) =
      _$MemoryPackCopyWithImpl;
  @useResult
  $Res call({List<dynamic> memories, Map<String, dynamic> metadata});
}

/// @nodoc
class _$MemoryPackCopyWithImpl<$Res> implements $MemoryPackCopyWith<$Res> {
...
extension MemoryPackPatterns on MemoryPack {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MemoryPack value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<dynamic> memories, Map<String, dynamic> metadata)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _MemoryPack() when $default != null:
        return $default(_that.memories, _that.metadata);
      case _:
        return orElse();
    }
  }
...
class _MemoryPack implements MemoryPack {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MemoryPackCopyWith<_MemoryPack> get copyWith =>
      __$MemoryPackCopyWithImpl<_MemoryPack>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$MemoryPackToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$MemoryPackCopyWith<$Res>
    implements $MemoryPackCopyWith<$Res> {
  factory _$MemoryPackCopyWith(
          _MemoryPack value, $Res Function(_MemoryPack) _then) =
      __$MemoryPackCopyWithImpl;
  @override
  @useResult
  $Res call({List<dynamic> memories, Map<String, dynamic> metadata});
}
...
/// @nodoc
class __$MemoryPackCopyWithImpl<$Res> implements _$MemoryPackCopyWith<$Res> {
