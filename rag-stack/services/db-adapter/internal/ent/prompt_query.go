...
func (_q *PromptQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *PromptQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *PromptQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *PromptQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *PromptQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *PromptQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PromptQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(prompt.Table, prompt.Columns, sqlgraph.NewFieldSpec(prompt.FieldID, field.TypeInt64))
	_spec.From = _q.sql
