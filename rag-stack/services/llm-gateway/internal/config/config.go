...
func Load() *Config {
	return &Config{
		...
		RequestTopic:    getEnv("PULSAR_REQUEST_TOPIC", "persistent://rag-pipeline/data/llm-tasks"),
		ResponseTopic:   getEnv("PULSAR_RESPONSE_TOPIC", "persistent://rag-pipeline/data/llm-results"),
