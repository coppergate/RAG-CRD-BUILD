...
func (s *QdrantSearcher) Search(ctx context.Context, embeddingModel string, vector []float32, tags []int64, sessionID int64, includeGlobal bool, limit int) ([]interface{}, error) {
...
func (s *QdrantSearcher) RetrieveByPaths(ctx context.Context, embeddingModel string, paths []string) ([]interface{}, error) {
	if len(paths) == 0 {
		return nil, nil
	}
