...
IMAGE_GROUPS[bootstrap]="busybox:1.37.0 busybox:1.36 amazon/aws-cli:2.34.4 martizih/kaniko:v1.27.0 gcr.io/kaniko-project/executor:v1.24.0 quay.io/operator-framework/olm@sha256:e74b2ac57963c7f3ba19122a8c31c9f2a0deb3c0c5cac9e5323ccffd0ca198ed quay.io/operator-framework/configmap-operator-registry:latest quay.io/operatorhubio/catalog:latest quay.io/jetstack/cert-manager-cainjector:v1.19.2 quay.io/jetstack/cert-manager-controller:v1.19.2 quay.io/jetstack/cert-manager-acmesolver:v1.19.2 quay.io/jetstack/cert-manager-webhook:v1.19.2 registry.k8s.io/metrics-server/metrics-server:v0.8.1 ghcr.io/headlamp-k8s/headlamp:v0.25.0"
